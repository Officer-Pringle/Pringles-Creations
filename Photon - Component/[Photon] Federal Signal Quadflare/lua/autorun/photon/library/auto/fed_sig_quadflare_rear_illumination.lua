...
local name = "Federal Signal Quadflare Illumination"
-- This is for Rear Illumination Only
...
--[[-------------------------------------------------------------------------
                        HOW TO USE
                    Add This to your Illumination Code
---------------------------------------------------------------------------]]   
--[[
Illumination = {
        {
            ...
            Preset_Components = {},
            Lights = {
                { Vector( 0, -65, 90 ), Angle( 10, 270, 0 ), "flood" },
            },
            Disconnect = {}
        },
    }
