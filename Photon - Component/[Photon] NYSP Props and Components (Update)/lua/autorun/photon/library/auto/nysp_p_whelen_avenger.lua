...
local name = "NYSP Whelen Avenger Front"
...
local name = "NYSP Whelen Avenger Rear"
...
COMPONENT.Patterns = {
	["auto_whelen_avenger"] = {
		...
		["cat"] = { 3,3,3,0,1,1,1,0,1,1,1,0,2,2,2,0,2,2,2,0,3,3,3,0,0,2,2,0,1,0,2,0,3,0,1,2,0,1,0,2,3,1,0,2,0,3,1,0,2,0,2,1,0,3,0,1,0,0,2,0,3,0,0,1,0,3,0,0,2,0,2,1,0,3,0,3,1}
	}
}
