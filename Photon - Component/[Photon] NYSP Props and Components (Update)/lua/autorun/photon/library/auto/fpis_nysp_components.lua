...
local name = "NYSP FPIS13 Reverse"
...
COMPONENT.Positions = {
	...
	[1] = { Vector( -27.78, -112.7, 52.59 ), Angle( 0, -29, -16 ), "tail_light_src", 5 }, -- 1
	[2] = { Vector( 27.78, -112.7, 52.59 ), Angle( 0, 29, 180-16 ), "tail_light_src", 5 }, -- 2
...
name = "NYSP FPIS13 Wig-Wag Headlights"
COMPONENT = {}
...
name = "NYSP FPIS13 Turn Signal Hideaways"
COMPONENT = {}
...
name = "NYSP FPIS13 Front Hideaways"
COMPONENT = {}
...
COMPONENT.Positions = {
	...
	[1] = { Vector( -30.26, 111.97, 36.12 ), Angle( 0, 27, 0 ), "front_marker", 5 },
	[2] = { Vector( 30.26, 111.97, 36.12 ), Angle( 0, -27, 180 ), "front_marker", 5 },

	[3] = { Vector( -28.15, 111.57, 39.32 ), Angle( 0, 35, 0 ), "front_3", 5 },
	[4] = { Vector( 28.15, 111.57, 39.32 ), Angle( 180, -35, 180 ), "front_3", 5 },

	[5] = { Vector( -28.97, 112.2, 37.62 ), Angle( 0, 35, 0 ), "front_2", 5 },
	[6] = { Vector( 28.97, 112.2, 37.62 ), Angle( 180, -35, 180 ), "front_2", 5 },
}
